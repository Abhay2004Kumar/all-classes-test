          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="text-xl lg:text-2xl text-gray-700 mb-8 leading-relaxed">
                <span className="font-bold">All The Classes Talent Hunt 2025</span> में अपनी प्रतिभा दिखाएं और जीतें <span className="text-amber-600 font-bold">₹1 Lakh+</span> के आकर्षक पुरस्कार!
              </p>
